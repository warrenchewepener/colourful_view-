...
# Here I import the necessary dependancies
...
# Here I name the image 

cv2.namedWindow('A picture of our sun')
cv2.setMouseCallback('A picture of our sun', draw_function)

while True:

    cv2.imshow("A picture of our sun", img)
    if clicked:
